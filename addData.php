...
if ($postOverflowed) {
    ...
    if (rp_clean_string($_POST['website'] ?? '', 100) !== '') {
        rp_redirect('addData.php?sent=' . urlencode(rp_generate_code()));
    }
...
<?php if ($submitted !== null && $submitted !== ''): ?>
    <div class="card success-card">
        ...
        <p>
            <a class="btn btn-primary" href="<?= e(rp_url('addData.php')) ?>"><?= e(__('success.new_one')) ?></a>
...
<?php else: ?>
    <div class="card">
        ...
        <form method="post" action="<?= e(rp_url('addData.php')) ?>" enctype="multipart/form-data" novalidate>
            <?= rp_csrf_field() ?>
            <p class="honeypot">
